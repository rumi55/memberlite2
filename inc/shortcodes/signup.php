...
*/
function pmprot_signup_shortcode($atts, $content=null, $code="")
{
	...
	?>
		...
		<form class="pmpro_form pmprot_signup" action="<?php echo pmpro_url("checkout"); ?>" method="post">
...
add_shortcode("pmprot_signup", "pmprot_signup_shortcode");